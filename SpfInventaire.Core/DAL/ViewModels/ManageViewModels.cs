...
namespace SpfInventaire.Core.DAL.ViewModels
{
    ...
    public class ChangePasswordViewModel
    {
        ...
        [Required]
        [StringLength(100, ErrorMessage = "Le nouveau mot de passe doit avoir une longueur minimum de {2} caractères.", MinimumLength = 6)]
        [DataType(DataType.Password)]
    ...
    {
        [Required]
        [DataType(DataType.EmailAddress, ErrorMessage = "Addresse Email non valide")]
